...
class TemperaturesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create temperature" do
    assert_difference('Temperature.count') do
      post temperatures_url, params: { temperature: { dateTemperature: @temperature.dateTemperature, node_id: @temperature.node_id } }
    end
  ...
  test "should update temperature" do
    patch temperature_url(@temperature), params: { temperature: { dateTemperature: @temperature.dateTemperature, node_id: @temperature.node_id } }
